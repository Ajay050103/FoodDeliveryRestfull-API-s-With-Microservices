...
public class OrderServiceImpl implements OrderService{
	...
	private  String fetchRestaurantName(long restaurantId) {
		return restTemplate.getForObject("http://RESTAURANTMANAGEMENT/restaurant/name/"+restaurantId, String.class);
	}

	@Override
	@CircuitBreaker(name = "restaurantCB" ,fallbackMethod = "fallBackForRestaurantManagement")
	public String getRestaurantName(long restaurantId) {
		return restTemplate.getForObject("http://RESTAURANTMANAGEMENT/restaurant/name/"+restaurantId, String.class);
	}
	
	public String fallBackForRestaurantManagement(long restaurentId ,Throwable throwable) {
